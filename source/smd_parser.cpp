...
static bool IsPredefinedReadOnlyName(const std::string& n) {
	static const char* kFixed[] = {
		...
		"Game_NVN_Timestamp_int",
		"Game_NVN_SamplesPassed_int",
		"Game_NVN_InputVertices_int",
		"Game_NVN_InputPrimitives_int",
		"Game_NVN_VertexShaderInvocations_int",
		"Game_NVN_TessControlShaderInvocations_int",
		"Game_NVN_TessEvaluationShaderInvocations_int",
		"Game_NVN_GeometryShaderInvocations_int",
		"Game_NVN_FragmentShaderInvocations_int",
		"Game_NVN_TessEvaluationShaderPrimitives_int",
		"Game_NVN_GeometryShaderPrimitives_int",
		"Game_NVN_ClipperInputPrimitives_int",
		"Game_NVN_ClipperOutputPrimitives_int",
		"Game_NVN_PrimitivesGenerated_int",
		"Game_NVN_TransformFeedbackPrimitivesWritten_int",
		"Game_NVN_TilesProcessedByZcull_int",
		"Game_NVN_PixelBlocksBehindPrimitivesAndCulled_int",
		"Game_NVN_PixelBlocksInFrontOfPrimitivesCulled_int",
		"Game_NVN_PixelBlocksFailedStencilTestAndCulled_int",
		// System
